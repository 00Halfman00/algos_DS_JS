...
class min_binary_heap_priority_queue:
  ...
  """
    ...
    def _heap_up(self):
        ...
        p_Idx = (c_Idx - 1) // 2
        #  loop while parent index is zero or greater and parent's priority is higher than childs
  ...
  """
    ...
    def _heap_down(self):
        ...
        while (
            l_child_idx < len(self.nodes)
            and self.nodes[l_child_idx].priority < self.nodes[p_idx].priority
        ) or (
