...
/*
  1.  CREATE A FUNCTION NAMED threeSum
      ( IT WILL TAKE AN ARRAY OF NUMBERS AND RETURN A DIFFERENT ARRAY WITH SUBARRAYS CONTAINING ANY
       ...
       A. IT WILL TAKE AN ARRAY OF NUMBERS/INTEGERS AS ITS PARAMETER NAMED numsArr
       B. SORT THE numsArr ARRAY
       ...
       F. LOOP OVER THE numsArr ARRAY
          ...
          II.   IF i IS GREATER THAN ZERO AND IF THE NUMBER AT INDEX i IN numsArr IS THE SAME AS THE
                NUMBER BEFORE IT IN numsArr
          ...
          IV.   ASSIGN target THE OPPOSITE VALUE OF THE NUMBER AT INDEX i IN numsArr
          V.    LOOP OVER LEFT AND RIGHT WHERE LEFT IS INITIATED WITH THE VALUE OF i + 1 WHICH IS
                ...
                b.  IF THE VALUE OF target EQUALS THE VALUE OF subtrahend
                    ...
                    b5. NOW THAT THERE IS NO NUMBER THAT IS THE SAME NUMBER INFRONT OF left IN THE
                        numsArr AND THAT YOU HAVE ALREADY USED IT
                    ...
                    b6. NOW THAT THERE IS NO NUMBER THAT IS THE SAME NUMBER BEFORE THE NUMBER AT
                        INDEX right IN THE numsArr AND THAT YOU HAVE USED ALREADY USED IT
                        - DECREASE RIGHT BY ONE TO MOVE IN THE NEXT ITERATION ON THE NEXT NUMBER,
                          MOVING FROM RIGHT TO LEFT
                c.  ELSE IF THE VALUE NEEDED TO EQUAL target MUST TO BE GREATER
                    c1. INCRESE left BY ONE
                d.  ELSE THE VALUE NEEDED TO EQUAL target MUST TO BE SMALLER
